 ...
 * @author pabli
 */
public class editarPromocionAction extends ActionSupport {
    ...
    public editarPromocionAction() {
    }
    
    public String execute() throws Exception {
        Promocion promocionT = new Promocion();
        
        promocionT.setId(idPromocion);
        ...
        promocionDAO.edit_XML(obj_paquete, String.valueOf(idPromocion));
