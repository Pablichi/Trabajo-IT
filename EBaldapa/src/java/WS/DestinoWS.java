...
/**
 * Jersey REST client generated for REST resource:DestinoFacadeREST
 * [servicios.destino]<br>
 * USAGE:
 * <pre>
 *        DestinoWS client = new DestinoWS();
...
public class DestinoWS {
    ...
    public DestinoWS() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.destino");
    }
