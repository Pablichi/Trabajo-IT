...
/**
 * Jersey REST client generated for REST resource:PromocionFacadeREST
 * [servicios.promocion]<br>
 * USAGE:
 * <pre>
 *        PromocionWS client = new PromocionWS();
...
public class PromocionWS {
    ...
    public PromocionWS() {
        ...
        webTarget = client.target(BASE_URI).path("servicios.promocion");
    }
